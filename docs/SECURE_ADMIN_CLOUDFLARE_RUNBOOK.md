...
- `assets/admin-auth.js`: 관리자 화면 인증·역할 확인·로그아웃
- `admin-login/index.html`: 개인별 직원 로그인
- `_headers`: Cloudflare Pages 보안·캐시 헤더
- `tools/build-cloudflare-pages.mjs`: 공개 파일만 `dist`로 모으고 Pages 파일 제한 검사
